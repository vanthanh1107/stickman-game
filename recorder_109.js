// ==========================================
// RECORDER.JS - V68.0 MP4 ULTIMATE EDITION (FULL SIZE)
// Tối ưu Layout: Clean Game -> HUD -> Short Yellow Text -> Poll -> Smart Alerts -> Chat -> Cat 
// ĐÃ FIX: LỖI DROP FRAME CHỐT FILE KHÔNG LƯU ĐƯỢC
// ĐÃ FIX: LỖI BẢNG TẢI VIDEO KHÔNG HIỂN THỊ (FIXED MODAL XUYÊN GAME)
// ĐÃ THÊM: THÔNG BÁO RENDERING CHO NGƯỜI CHƠI
...
// ====================================================================
// ENGINE AI NỘI BỘ TẠO TIÊU ĐỀ & HASHTAG (ĐỘC QUYỀN NGÁCH MỚI)
// ====================================================================
window.StoryModeAI = {
...
// ==========================================
// [NEW TÍNH NĂNG]: TOAST NOTIFICATION KHI ĐANG RENDER
// Tránh việc người chơi tưởng web treo rồi F5 mất video
// ==========================================
...
window.startRecording = function() {
    ...
    const finalizeRecordings = () => {
        ...
        if (stoppedCount === 2) { 
            setTimeout(() => {
                window.hideRenderToast(); // Tắt thông báo render đi
                ...
                // GỌI HÀM HIỂN THỊ UI SAU KHI LƯU XONG
...
// ==========================================
// [FIX CHÍNH]: NGẮT RECORD AN TOÀN ĐỂ KHÔNG MẤT FILE
// ==========================================
window.stopRecording = function() { 
    if (!window.isRecording) return; 
    window.isRecording = false; 

    window.showRenderToast(); // Bật thông báo đang Render
    ...
    // [LỖI CŨ LÀ DỪNG TRACK TRƯỚC LÀM ĐỨT NGẦM DATA]
    // BƯỚC 1: PHẢI DỪNG RECORDER TRƯỚC
    ...
    // BƯỚC 2: DELAY NỬA GIÂY RỒI MỚI TẮT TRACK STREAM ĐỂ NÓ CHỐT FILE HOÀN HẢO
    setTimeout(() => {
...
// ==========================================
// [FIX CHÍNH BẢN 68]: BẢNG VIDEO GIAO DIỆN MODAL FIXED XUYÊN GAME
