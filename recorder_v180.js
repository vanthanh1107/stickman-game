// ==========================================
// RECORDER.JS - V76.9 GLOBAL TOXIC MULTIVERSE
// ĐÃ FIX & GIỮ NGUYÊN: Tải tức thì, Esports HUD, Chat Kính Mờ, Impact VFX.
// NÂNG CẤP V76.9 (STORY MAX): 
// 1. MULTI-LANGUAGE: Cốt truyện đa ngôn ngữ (Việt, Anh Brainrot, Hàn, Nhật, Tây Ban Nha, Thái).
// 2. FUNNY & TOXIC: Lời thoại siêu khịa, tạo thành các câu chuyện siêu giải trí.
// ==========================================
...
window.STORY_TEMPLATES = [
    // 1. KỊCH BẢN TIẾNG ANH: GEN-Z BRAINROT (Siêu Viral TikTok Âu Mỹ)
    [
    ...
    // 2. KỊCH BẢN TIẾNG VIỆT: TRẺ TRÂU GÁY BẨN
    [
    ...
    // 3. KỊCH BẢN TIẾNG HÀN: TRYHARD FAKER WANNABE
    [
    ...
    // 4. KỊCH BẢN TIẾNG TÂY BAN NHA: TELENOVELA TOXIC
    [
    ...
    // 5. KỊCH BẢN TIẾNG NHẬT: CHUUNIBYOU ANIME BOSS FIGHT
    [
    ...
    // 6. KỊCH BẢN TIẾNG THÁI: RAGE GAMER
    [
        ...
        { triggerHp: 0.6, speaker: "P1", text: "เน็ตปิงโว้ยยยย อย่าเพิ่งห้าว! (Mạng lag thôi, đừng có gáy!) 🤬📶", face: "https://files.catbox.moe/v68cni.png", duration: 4000 },
        { triggerHp: 0.4, speaker: "P2", text: "ข้ออ้างเยอะจัด อ่อนก็บอกว่าอ่อน (Lý do lý trấu, yếu thì nhận đi) 🐔", face: "https://files.catbox.moe/v2rt0n.png", duration: 4000 },
        { triggerHp: 0.2, speaker: "P1", text: "เอาล่ะนะ เอาจริงละเว้ย! ตายซะ! (Được rồi, tao chơi thật đây! Chết!) 💀🔥", face: "https://files.catbox.moe/t0h9n6.png", duration: 4500 }
    ],
    // 7. KỊCH BẢN TIẾNG VIỆT: ĐẠI GIA PAY TO WIN VS DÂN CÀY
    [
