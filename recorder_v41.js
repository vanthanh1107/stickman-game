// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V57.3 - EXTENDED OUTRO EDITION)
// [FIXED] Kéo dài thời gian ghi hình sau K.O lên 6 giây để màn hình Outro (Chốt sale) hiển thị đủ lâu cho người xem đọc.
// [RETAINED] Cỗ máy chế Meme Thumbnail: Text 3D đùn khối, Nền Sunburst/Manga, Vòng đỏ, Mắt laze đỏ bựa.
// [RETAINED] Snap-cut 1.5s đầu tiên sắc lẹm để làm Intro Hook chuẩn TikTok/Shorts.
// ==========================================
