...
// GIAO DIỆN V2: Thông báo ngang hàng LIVE, Watermark chìm trong chat, Facecam nhét góc trên phải Chat box.
// ==========================================
...
window.captureFrames = function() {
    ...
    if (renderNormalV) {
        ...
        if (!isOutroActive) {
            ...
            // =========================================================
            let boxWidth = 960; let boxHeight = 850; let boxX = 540; let boxY = 1450; 
            ...
            // 3. FACECAM GÁI XINH NẰM GÓC TRÊN BÊN PHẢI CỦA BẢNG CHAT
            ...
            if (window._facecamImg && window._facecamImg.complete) {
                ...
                let camY = -boxHeight/2 + camH/2 + 80; // Nhét gọn trong viền phải phía trên
