...
window.drawStickman = function(ctx, p, isTrail = false) {
    ...
    // Đăng ký maxT để tính Progress trong hàm drawBaseLimb
    p.maxT = maxT;
    ...
    // Nếu nhân vật từ tệp char_*.js đã nạp xong phương thức vẽ riêng
    ...
    // NẾU CHƯA LOAD ĐƯỢC FILE NHÂN VẬT TÙY CHỈNH -> VẼ KHUNG MẶC ĐỊNH
