// ==========================================
// RECORDER.JS - V76.11 LORE & STABILITY UPDATE
// ĐÃ FIX: Lỗi tải xuống video trên một số trình duyệt (Thêm DOM append).
// NÂNG CẤP V76.11: 
// 1. CLASS STATS LORE: Thêm hệ thống nhân vật đối nghịch (Hacker vs Admin, Tryhard vs Whale).
// 2. STABILITY: Hoạt động mượt mà, tải thẳng video ngay lập tức.
// ==========================================

// ==========================================
// KHAI BÁO NHÂN VẬT (CLASS STATS) - LORE ĐỐI LẬP
// ==========================================
window.classStats = window.classStats || {};
Object.assign(window.classStats, {
    "hacker": {
        name: "ZERO_DAY HACKER",
        className: "Hacker",
        avatarUrl: "https://files.catbox.moe/v68cni.png", // Ảnh Não To/Glitch
        lore: "Kẻ phá vỡ luật lệ, thao túng mã nguồn."
    },
    "admin": {
        name: "SYSTEM ADMIN",
        className: "Dev",
        avatarUrl: "https://files.catbox.moe/t0h9n6.png", // Ảnh Gigachad/Ngầu
        lore: "Người bảo vệ Server, có quyền năng BAN vĩnh viễn."
    },
    "tryhard": {
        name: "SWEATY PRO",
        className: "Tryhard",
        avatarUrl: "https://files.catbox.moe/kixqol.png", // Ảnh Đổ mồ hôi/Tryhard
        lore: "Chơi bằng 200% kỹ năng. Căm thù Hacker và P2W."
    },
    "whale": {
        name: "VIP 10 WHALE",
        className: "PayToWin",
        avatarUrl: "https://files.catbox.moe/v2rt0n.png", // Ảnh Cầm tiền/Ngạo mạn
        lore: "Dùng tiền đè người, kỹ năng không quan trọng."
    }
});
...
window.STORY_TEMPLATES = [
    ...
    [
        { triggerHp: 0.8, speaker: "P2", text: "Skin mặc định rách rách? Để VIP 10 dạy mày cách chơi! 💸🗿", face: "https://files.catbox.moe/v2rt0n.png", duration: 4000 },
        { triggerHp: 0.6, speaker: "P1", text: "Nạp tiền mua skin chứ đéo mua được kỹ năng đâu con! 🧠", face: "https://files.catbox.moe/t0h9n6.png", duration: 4000 },
        { triggerHp: 0.4, speaker: "P2", text: "Thế kỹ năng của mày là dùng mặt để đỡ đòn à? Ha ha ha! 🤡", face: "https://files.catbox.moe/kixqol.png", duration: 4000 },
        { triggerHp: 0.2, speaker: "P1", text: "Cười đi! Trùm cày cuốc tao nện cho vỡ mồm giờ! 👊💥", face: "https://files.catbox.moe/v68cni.png", duration: 4500 }
    ]
];
...
// ==========================================
// THUMBNAIL TIKTOK (CLICKBAIT GENERATOR)
// ==========================================
window.bakeThumbnailsForVideo = function() {
    ...
    try {
        ...
        drawCharSafe(ctxV, e1, 800, 1200, 8.5, false, true); 
        ...
        ctxV.save();
        ctxV.translate(450, 600); 
        ctxV.rotate(Math.PI / 4); 
        ...
        const drawClickbaitText = (text, x, y) => {
            ctxV.save();
            ctxV.translate(x, y); ctxV.rotate(-0.05); 
            ...
            ctxV.fillStyle = "#ffffff"; ctxV.fillText(text, -5, -5); 
            ctxV.restore();
        };
...
window.mergeAndDownloadVideo = function(vidId) {
    ...
    try {
        ...
        a.href = vid.urlV;
        a.download = "TIKTOK_" + (vid.safeFileName || "VIDEO") + "." + (vid.ext || "mp4");
