...
// GIAO DIỆN MỚI: Facecam rời ngoài game, View+Live nhúng trong game, Thông báo TikTok bay trái.
// ==========================================
...
window.captureFrames = function() {
    ...
    if (renderNormalV) {
        ...
        // HIỂN THỊ "LIVE & VIEWERS" TRONG GÓC GAME BÊN PHẢI
        ...
        if (!isOutroActive) {
            ...
            let boxWidth = 960; let boxHeight = 700; let boxX = 540; let boxY = 1420; 

            // =========================================================
            // HỆ THỐNG THÔNG BÁO TIKTOK (BOTTOM LEFT, BAY LÊN)
            // =========================================================
            ...
            let alertStartX = 60; 
            let alertStartY_Left = boxY - boxHeight/2 - 20; // Bay từ sát trên đỉnh bảng chat
            ...
            for (let i = window._liveAlerts.length - 1; i >= 0; i--) {
                ...
                if(ctxV.roundRect) { ctxV.beginPath(); ctxV.roundRect(0, 0, textW + 40, 46, 23); ctxV.fill(); } else { ctxV.fillRect(0, 0, textW + 40, 46); } 
                ctxV.fillStyle = "#fff"; ctxV.textAlign = "left"; ctxV.textBaseline = "middle"; 
                ctxV.fillText(al.text, 15, 23); 
                ctxV.restore(); 
                if (al.life <= 0) window._liveAlerts.splice(i, 1);
            }

            // =========================================================
            // FACECAM STREAMER BÊN NGOÀI GAME (TOP RIGHT TRÊN CHAT)
            // =========================================================
            ...
            if (window._facecamImg && window._facecamImg.complete) {
                ...
                let camX = boxX + boxWidth/2 - camW/2; 
                let camY = boxY - boxHeight/2 - camH/2 - 20;
            ...
            ctxV.fillText("💬 " + (window.CREATOR_HANDLE || "Sticklom") + " CHAT", -boxWidth/2 + 30, -boxHeight/2 + 30); 
