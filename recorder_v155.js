...
// GIAO DIỆN V3 (FINAL): Chat box cao đụng Win Rate, LIVE CHAT header, Facecam nằm gọn góc trên Chat.
// ==========================================
    ...
    if (renderNormalV) {
        ...
        if (!isOutroActive) {
            ...
            if (window._facecamImg && window._facecamImg.complete) {
                ...
                let camY = -boxHeight/2 + camH/2 + 75; // Sát mép dưới của header (header height = 60)
