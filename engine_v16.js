// ==========================================
// ENGINE.JS - THE ABSOLUTE ULTIMATE MASTERPIECE 15.0 [FINAL PURE-CORE]
// [FIXED 100%: LỖI VỆT SÁNG ĐỌNG LẠI (Đã khôi phục bộ đếm vòng đời VFX)]
// [TÍNH NĂNG: GPU SIN CITY FINISHER, HARD-RESET VRAM, NEON PARTICLES, 120HZ]
// ==========================================
...
window.update = function() {
    ...
    // ==========================================
    // KHÔI PHỤC VÒNG ĐỜI CÁC VFX Ở ĐÂY ĐỂ CHỐNG DÍNH MÀU
    // ==========================================
    if (!isTimeStopped) {
    ...
    // QUAN TRỌNG: XÓA SLASHES NẾU KHÔNG SẼ DÍNH HÌNH!
...
window.draw = function() {
    ...
    // [FIX TỐI THƯỢNG 15.0]: HARD-RESET 100% MA TRẬN KẾT XUẤT 
    ...
    if (window.isLoading) {
        ...
        window.ctx.fillStyle = "#00f3ff"; window.ctx.font = "italic 900 40px Arial"; window.ctx.textAlign = "center"; window.ctx.shadowBlur = 15; window.ctx.shadowColor = "#00f3ff"; window.ctx.fillText("INITIALIZING PURE-CORE 15.0...", cx, cy - 50);
