...
// ĐÃ NÂNG CẤP: 100% CELEB CHAT + TOXIC COMMENTS "HỦY DIỆT" SIÊU ĐA DẠNG + FULL ENGLISH UI
// ==========================================
...
window.generateLiveChatEvent = function() {
    ...
    // 3. MIX CÁC CẤU TRÚC ĐỂ TẠO CÂU ĐỘC NHẤT
...
window.captureFrames = function() {
    ...
    if (!isOutroActive) {
        ...
        // --- THÔNG BÁO LIVE ALERTS TỪ CELEB ---
