...
// [BẢN HOÀN CHỈNH ULTIMATE: PENDING HIT + HIT-STOP + JUGGLE + PROJECTILE IMAGES]
// ==========================================
...
// 🟢 NÂNG CẤP IMAGE URL PROJECTILES
...
// ==========================================
// 4. HỆ THỐNG VẬT LÝ NHẬN SÁT THƯƠNG & ATTACK (ULTIMATE PATCHED)
// ==========================================
...
window.attack = function(attacker, targetGroup) {
    ...
    // 🟢 SÁT THƯƠNG CHỜ (KHỚP FRAME HOẠT ẢNH)
    attacker.pendingHit = {
        target: target,
...
window.update = function() {
    ...
    // 🟢 XỬ LÝ SÁT THƯƠNG CHỜ (PENDING HIT - ULTIMATE PATCH)
    allFighters.forEach(f => {
