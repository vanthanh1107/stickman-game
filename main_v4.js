...
// 👉 CHÚ Ý: GỌI HÀM NÀY ĐẦU TIÊN TRONG HÀM RENDER CHÍNH CỦA BẠN (TRƯỚC KHI VẼ NHÂN VẬT)
window.drawGhostTrails = function(ctx) {
    ...
    window.ghostTrails.forEach(t => {
        ...
        else if (typeof window.drawStickman === 'function') window.drawStickman(ctx, t);
...
// 👉 CHÚ Ý: GỌI HÀM NÀY NGAY TRƯỚC KHI VẼ NHÂN VẬT TRONG LÚC RENDER
...
// THAY THẾ HÀM TẠO TEXT CHỮ CỦA BẠN BẰNG HÀM NÀY KHI TÍNH SÁT THƯƠNG
...
// 👉 CHÚ Ý: DÙNG HÀM NÀY ĐỂ VẼ CHỮ SÁT THƯƠNG THAY CHO HÀM CŨ TRONG RENDER LOOP CỦA BẠN
