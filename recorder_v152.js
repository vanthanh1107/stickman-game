// ==========================================
// RECORDER.JS - V75.5 THE ALGORITHM BREAKER (RETENTION HACKER EDITION)
...
// TÂM LÝ HỌC (NEW): Tối ưu tên Sticklom, Chat gọn gàng, FACE-CAM GÁI XINH REACT THEO NHỊP COMBAT.
// ĐÃ KHÔI PHỤC: Hệ thống thông báo Follow, Like, Tặng Hoa (Rose) trôi lên phía trên khung chat.
// ==========================================
...
// ẢNH FACECAM STREAMER CÂU VIEW (Gái xinh gaming) - Bạn có thể thay link ảnh khác nếu muốn
...
window.startRecording = function() {
    ...
    window._liveAlerts = []; window._lastAlertTime = Date.now(); // Reset hệ thống thông báo thả tim/follow
...
window.captureFrames = function() {
    ...
    if (renderNormalV) {
        ...
        // =========================================================
        // FACECAM GÁI XINH REACT VÀO TRONG GAME
        // =========================================================
        ...
        if (!isOutroActive) {
            ...
            // =========================================================
            // HỆ THỐNG THÔNG BÁO HOẠT ĐỘNG LIVE (LIKE, FOLLOW, ROSE)
            // =========================================================
            ...
            for (let i = window._liveAlerts.length - 1; i >= 0; i--) {
                ...
                ctxV.lineWidth = 2;
                if(ctxV.roundRect) { 
                    ctxV.beginPath(); ctxV.roundRect(-textW/2 - 20, 0, textW + 40, 46, 23); ctxV.fill(); ctxV.stroke(); 
                } else { 
                    ctxV.fillRect(-textW/2 - 20, 0, textW + 40, 46); 
                } 
                ctxV.fillStyle = "#fff"; ctxV.textAlign = "center"; ctxV.textBaseline = "middle"; ctxV.fillText(al.text, 0, 23); 
                ctxV.restore(); 
            ...
            ctxV.fillText("💬 LIVE CHAT", -boxWidth/2 + 30, -boxHeight/2 + 35); ctxV.font = "900 28px 'Arial'"; ctxV.textAlign = "right"; ctxV.fillText("👥 " + window._fakeViewers.toLocaleString() + " VIEWERS", boxWidth/2 - 30, -boxHeight/2 + 35);
