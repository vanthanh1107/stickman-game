// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V66.1 - TIKTOK SPLIT-SCREEN RETENTION META)
// [NEW] Bố cục Split-Screen: Game 16:9 ở trên, Retention Zone Cyberpunk ở dưới.
// [NEW] Dịch chuyển toàn bộ HUD xuống Retention Zone cực rõ nét.
// [FIX] Dời nút Subscribe xuống vùng trống, xóa bộ đếm Hit thừa ở bản dọc.
...
window.captureFrames = function() {
    ...
    if (!window.gameOver) {
        // Chỉ vẽ COMBO cho bản NGANG (PC), bản Dọc đã bị xóa để tránh rối mắt
        ...
        // SUBSCRIBE BUTTON 2K (ĐÃ DỊCH CHUYỂN XUỐNG DƯỚI CÙNG RETENTION ZONE)
        let subY = (typeof splitGameHeight !== 'undefined') ? splitGameHeight + 550 : 1400; // Nằm an toàn ở Retention Zone, dưới thanh máu
        ctxV.save(); ctxV.translate(720, subY); let subScale = 1 + (audioPeak * 0.12); ctxV.scale(subScale, subScale);
