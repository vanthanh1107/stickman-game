...
// [TÍNH NĂNG: TỐI ƯU BỘ NHỚ, FLASH STEP, GUARD BREAK, AWAKENING, SIN CITY]
// ==========================================
...
// BIẾN HỆ THỐNG PRELOAD & TỐI ƯU BỘ NHỚ (ANTI-LAG)
...
window.update = function() {
    ...
    // QUẢN LÝ THỜI GIAN HIỆU ỨNG TẠI ĐÂY (ĐỂ KHÔNG BỊ X2 TỐC ĐỘ Ở 120Hz)
    ...
    if (window.p1 && window.p1.hp > 0 && window.p1.hp <= window.p1.maxHp * 0.2 && !window.gameOver) { window.isLowHpPulsing += 0.1; }
...
// ==========================================
// 6. HỆ THỐNG VẼ ĐỒ HỌA TRUNG TÂM (DRAW) (RENDER CHẠY UNLOCKED THEO MÀN HÌNH)
// ==========================================
window.draw = function() {
    ...
    if (window.isLoading) {
        ...
        window.ctx.fillText("INITIALIZING ENGINE 11.0 PRO...", cx, cy - 50);
...
window.gameLoop = function(timestamp) { 
    ...
    if (deltaTime > 250) deltaTime = 250; // Chống lỗi vòng lặp tử thần khi chuyển Tab
    window.physicsAccumulator += deltaTime;

    // VÒNG LẶP VẬT LÝ BẢO TOÀN FPS GAME THỰC TẾ LÀ 60HZ
    ...
    // NỘI SUY MƯỢT MÀ CAMERA VÀ ĐỒ HỌA TRÊN MÀN HÌNH TẦN SỐ QUÉT CAO
...
// TỰ ĐỘNG KÍCH HOẠT HỆ THỐNG PRELOAD KHI FILE ĐƯỢC TẢI XONG
