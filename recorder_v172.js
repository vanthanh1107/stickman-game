// ==========================================
// RECORDER.JS - V76.4 THE ULTIMATE ALGORITHM BREAKER (UPDATE: WEBM YOUTUBE FIX & X2 SPEED RENDER)
// ĐÃ FIX & GIỮ NGUYÊN: Intro God-Tier, Vỡ kính 3D, Kill-Cam, Facecam Hậu Kỳ Không Giật Lag.
// NÂNG CẤP V76.4 (NEW MAX): 
// 1. ANIME SLASH PERFECT LOOP: Outro bị xé rách bởi vết chém Neon, hút frame Intro vào tạo vòng lặp 1000% không thể nhận ra!
// 2. KINETIC SUBTITLES: Tự động văng chữ "BRO NO WAY", "500 IQ" nảy giữa màn hình khi có sát thương lớn (MrBeast Style).
// 3. YOUTUBE UPLOAD FIX & 2X RENDER SPEED: Fix lỗi định dạng để up YouTube/Shorts mượt mà, kết xuất x2 tốc độ.
// ==========================================
...
// ========================================================
// HÀM GHÉP FACECAM VÀO VIDEO (ĐÃ FIX YOUTUBE UPLOAD & TÍCH HỢP X2 SPEED)
// ========================================================
window.mergeAndDownloadVideo = async function(vidId) {
    ...
    if(btn) btn.innerText = "⏳ ĐANG RENDER X2 TỐC ĐỘ...";
    window.showRenderToast("🔥 ĐANG GHÉP HẬU KỲ VÀ RENDER X2... RẤT NHANH THÔI!");
    ...
    // Tăng capture fps lên 60 để video x2 mượt mà hơn
    ...
    // =====================================
    // KÍCH HOẠT TÍNH NĂNG X2 TỐC ĐỘ 
    // =====================================
    rawVid.playbackRate = 2.0;
    faceVid.playbackRate = 2.0;
