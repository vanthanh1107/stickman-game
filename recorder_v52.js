// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V64.0 - SMOOTH SEEKING & EDITOR READY)
// [FIXED] Lỗi tua video bị giật khựng: Ép trình duyệt dùng H.264 Baseline Profile (Tắt B-frames) -> Tua mượt 100%.
// [FIXED] Lỗi video tải xuống bị ngắn: Sửa lại thuật toán xả bộ đệm nguyên khối (Solid Chunking) chuẩn MetaData.
...
// ==========================================
// 💥 HỆ THỐNG VẼ ANIMATED INTRO (NO-CLIP LAYERING SIÊU NHẸ)
// ==========================================
window.drawAnimatedIntro = function(ctx, w, h, isVertical, progress) {
    ...
    // --- KHUNG THOẠI TRASH TALK TỐI ƯU HIỆU NĂNG ---
    const drawSpeechAndEmoji = (x, y, text, isP1, emojiStr, popProgress) => {
        ...
        let tw = text.length * 22 + 80; let th = 90; 
...
window.startRecording = function() {
    ...
    // [FIX TUYỆT ĐỐI KHUNG HÌNH] Ép MP4 Baseline Profile (Không B-Frame) để tua video 100% mượt trên máy tính
    let options = { videoBitsPerSecond: 10000000 }; 
    window.currentVideoExt = "mp4";
    if (MediaRecorder.isTypeSupported('video/mp4; codecs="avc1.42E01E"')) { options = { mimeType: 'video/mp4; codecs="avc1.42E01E"', videoBitsPerSecond: 10000000 }; } 
...
window.stopRecording = function() { 
    ...
    // GỌI requestData() TRƯỚC KHI STOP ĐỂ ĐÓNG GÓI CHUẨN XÁC METADATA CHO PHẦN MỀM EDIT
