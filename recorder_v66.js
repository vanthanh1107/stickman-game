// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V66.15 - RAW UNCOMPRESSED ENGINE)
// [ULTIMATE FIX] MỞ KHÓA BITRATE LÊN 250 MBPS! KHÔNG BÓP DUNG LƯỢNG NỮA!
// [ULTIMATE FIX] XẢ THẲNG DỮ LIỆU THÔ (RAW) VÀO FILE -> CHỐNG DROP FRAME 100%.
// [ULTIMATE FIX] Loại bỏ VP9, ép dùng H.264 (GPU) hoặc VP8 để ghi hình siêu tốc.
// [ULTIMATE FIX] Khóa đồng bộ 60 FPS gốc của game, triệt tiêu hiện tượng lệch nhịp (Jitter).
// ==========================================
...
window.startRecording = function() {
    ...
    // [FIX MƯỢT TUYỆT ĐỐI] Ghi hình ở tốc độ 60FPS để khớp chính xác với vòng lặp của Game, loại bỏ hiện tượng đúp/khựng hình.
    ...
    // [FIX TỐI THƯỢNG] Ép Bitrate lên 250 Mbps! Ép xả Raw không nén để cứu CPU.
    let options = { videoBitsPerSecond: 250000000 }; 
    window.currentVideoExt = "mp4";

    // Ép dùng H264 (Hardware Encoding) hoặc VP8 (Software cực nhẹ). BỎ QUA VP9!
