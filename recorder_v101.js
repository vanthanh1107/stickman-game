...
window.captureFrames = function() {
    ...
    // [FIX RỚT FRAME]: Xóa bỏ hoàn toàn cơ chế bóp frame (throttle) cũ bằng performance.now()
    // Giờ đây hàm này sẽ chạy thuận theo tốc độ gốc của requestAnimationFrame (~60FPS). 
    // Video sẽ ghi lại đúng từng frame mượt mà như những gì bạn nhìn thấy trên màn hình.
