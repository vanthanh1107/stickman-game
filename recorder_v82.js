// ==========================================
// RECORDER.JS - V67.9 THE ULTIMATE SMOOTHNESS (MP4 60FPS V-SYNC)
// Xóa bỏ xung đột V-Sync, tắt desynchronized, nâng Bitrate lên 18Mbps
// Video xuất ra sẽ mượt rũ rượi chuẩn 60Hz không rớt 1 frame.
// ==========================================
...
window.initRecorder = function() {
    // [V67.9 FIX XẾ HÌNH] Bỏ "desynchronized: true" để Canvas đồng bộ tuyệt đối với Frame Rate
    let ctxOpts = {alpha: false, willReadFrequently: false}; 
...
window.startRecording = function() {
    ...
    // [V67.9 FIX ĐỒNG BỘ] Trở lại captureStream(60) chuẩn để đồng bộ mượt nhất
    ...
    // [V67.9 TĂNG TỐC ĐỘ NÉT] Bitrate MP4 phải từ 18Mbps trở lên mới xử lý mượt các hiệu ứng Glitch/Cháy nổ
...
window.captureFrames = function() {
    // [V67.9] Không dùng manual timer block nữa. Thuật toán game chạy requestAnimationFrame sẽ tự khóa cứng 60fps với CaptureStream(60)
