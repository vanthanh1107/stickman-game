// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V66.19 - BUTTER SMOOTH MAX)
// [KILL LAG 1] Xóa bỏ hoàn toàn ctx.filter (Sát thủ gây nghẽn GPU), FPS tăng gấp 3.
// [KILL LAG 2] Cân bằng Bitrate ở 35 Mbps (Lossless Quality) chống nghẽn I/O ổ cứng.
// [KILL LAG 3] Tối ưu hóa điều kiện vẽ hiệu ứng RGB Glitch, chỉ chạy khi Peak > 0.75.
// [RETAINED] VTuber AI, Binge-Watch Profile Grid, 3D Neon Grid, Follow Bouncer.
// ==========================================
...
window.startRecording = function() {
    ...
    // [FIX LÕI] Bitrate 35 Mbps - Mức lý tưởng nhất để cân bằng giữa Độ Nét 4K và Tốc độ ghi luồng
...
window.captureFrames = function() {
    ...
    // Reset nền thành đen hoàn toàn mỗi frame
    ...
    if (renderNormalH) {
        ...
        // Cập nhật điều kiện vẽ Glitch (Tăng giới hạn Peak lên 0.75 để bớt vẽ lại toàn màn hình)
        if (audioPeak > 0.75) {
