// ==========================================
// CHAR_BILLGATES.JS - NHÂN VẬT BILL GATES (KÈM AVATAR HÌNH ẢNH)
// ==========================================
...
window.currentLoadedChar = {
    ...
    drawMethod: function(ctx, p, bounce, ext, pext, isTrail) {
        ...
        // ==========================================
        // 3. VẼ ĐẦU NHÂN VẬT BẰNG AVATAR HÌNH ẢNH
        // ==========================================
        ...
        if (p.avatarUrl) {
            ...
            if (!window.avatarImageCache[p.avatarUrl]) {
                let img = new Image();
                img.crossOrigin = "Anonymous";
                img.src = p.avatarUrl;
                window.avatarImageCache[p.avatarUrl] = img;
            }

            let img = window.avatarImageCache[p.avatarUrl];
            ...
            if (img && img.complete && img.naturalWidth > 0) {
                ...
                // Vẽ viền Neon xanh dương bọc quanh đầu
                ctx.beginPath();
                ctx.arc(head.x, head.y - 4, headSize / 2, 0, Math.PI * 2);
                ctx.lineWidth = 2.5;
                ctx.strokeStyle = p.color || "#0984e3";
