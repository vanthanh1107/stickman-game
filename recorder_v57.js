// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V66.3 - NO INTRO FOR TIKTOK)
// [NEW] Bản Split-Screen dọc NHẢY THẲNG VÀO GAME (Xóa Thumbnail/Intro) để tối đa Retention.
// [NEW] Bản Ngang PC vẫn giữ đầy đủ Intro siêu ngầu.
// [FIX] Tối ưu hóa GPU Batch Drawing lưới Cyberpunk (Giảm lag triệt để).
...
window.captureFrames = function() {
    ...
    // Cờ kiểm soát việc vẽ bản NGANG (PC). Nếu đang trong thời gian chiếu Thumbnail/Intro,
    // Bản ngang sẽ vẽ Intro (renderNormalH = false), còn Bản dọc VẪN VẼ BÌNH THƯỜNG bỏ qua Intro.
    ...
    if (window.thumbnailHoldFrames > 0) {
        ...
        renderNormalH = false; // Tạm dừng vẽ Game cho bản ngang
    } 
        ...
        // Chỉ vẽ Animated Intro cho bản NGANG (ctxH)
    ...
    // --- RENDER BẢN NGANG 2K (Có Intro / Có Delay) ---
    if (renderNormalH) {
    ...
    // --- RENDER BẢN DỌC 2K (Split-Screen / NHẢY THẲNG VÀO GAME KO CẦN INTRO) ---
