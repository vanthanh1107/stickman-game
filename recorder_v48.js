// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V61.0 - MP4 HARDWARE ENCODING)
// [FIXED] Ép định dạng MP4 (H.264) sử dụng GPU phần cứng để render, chống giật lag 100%.
// [FIXED] Cải thiện Frame Rate bằng cách bọc lõi h264 vào webm nếu trình duyệt chặn mp4.
...
window.startRecording = function() {
    ...
    // [FIX] ÉP HARDWARE ENCODING (.MP4 / H.264) ĐỂ CHỐNG GIẬT LAG
    ...
    // KHÔNG ÉP CẮT LÁT (start(1000)) ĐỂ GIỮ TIMESTAMPS HOÀN HẢO CHO PREMIERE/CAPCUT
...
window.captureFrames = function() {
    ...
    // [CFR HACK] CHỐNG LỖI CẮT NGẮN CỦA PREMIERE/CAPCUT BẰNG ĐIỂM ẢNH TÀNG HÌNH ĐỔI MÀU
