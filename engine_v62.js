// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V66.10 - FINAL STABLE PATCH)
// [FIX] Ép trình duyệt ghi đè kích thước Canvas cũ để tránh lỗi tàng hình khu vực tải.
// [FIX] Loại bỏ lệnh cắt lát video (Chunking) gây crash ngầm trên một số máy.
// [FIX] Đảm bảo 100% video xuất ra cực mượt 60FPS ở chuẩn 1080p (Tương thích TikTok).
// [RETAINED] Toàn bộ Meta: Neon Grid, Text Highlight, RGB Glitch, Tia tốc độ.
// ==========================================
...
window.initRecorder = function() {
    // ÉP GHI ĐÈ KÍCH THƯỚC ĐỂ FIX LỖI TÀNG HÌNH NÚT TẢI
...
window.startRecording = function() {
    ...
    // Khởi chạy bình thường, gỡ bỏ chế độ cắt lát để tăng ổn định
...
window.captureFrames = function() {
    ...
    // ĐỒNG BỘ TỈ LỆ VẼ XUỐNG 1080P ĐỂ KHÔNG BAO GIỜ BỊ ĐƠ VIDEO
    ctxH.save(); ctxV.save();
