...
// ĐÃ NÂNG CẤP: AI SINH TIÊU ĐỀ & HASHTAG + AI TẠO NGƯỜI XEM & TOXIC COMMENTS VÔ HẠN
// ==========================================
...
// ====================================================================
// ENGINE AI NỘI BỘ TẠO NGƯỜI XEM & TOXIC COMMENTS (BẢNG CHAT BÊN DƯỚI)
// ====================================================================
window.generateLiveChatEvent = function() {
    ...
    const isCeleb = Math.random() < 0.15; // 15% tỷ lệ xuất hiện Celeb nổi tiếng cho hài hước
    ...
    if (isCeleb) {
        ...
        const namePrefixes = ["user", "Toxic", "Pro", "Noob", "Sigma", "Lil_", "Drip", "Ghost", "Shadow", "Slayer", "I_am_", "Real_", "Fake_"];
        const nameSuffixes = ["Gamer", "Boy", "God", "Demon", "King", "Master", "Z", "X", "_007", "69", "99"];
    ...
    // 2. TẠO COMMENT TOXIC
    const subjects = ["Bro", "Blud", "Lil bro", "This guy", "Dude", "My man", "He", "Bro really", "Dawg", "Broski"];
    const actions = [
        ...
        "looks lost", "is fighting for his life"
    ];
    const comparisons = [
    ...
    const templates = [
        ...
        () => `NAHHH WHAT WAS THAT ${r(emojis)}${r(emojis)}`,
...
window.captureFrames = function() {
    ...
    if (!isOutroActive) {
        ...
        if (!window._chatSystemInit) {
            ...
            for(let i = 0; i < 8; i++) {
                // Tự động đẩy người xem AI và lời nhắn Toxic AI vào Live Chat
