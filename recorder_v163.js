// ==========================================
// RECORDER.JS - V76.1 THE ALGORITHM BREAKER (PERFECT POST-PROCESSING)
...
// FIX LỖI V76.1: Khóa đồng bộ Async Load (Bắt buộc Facecam load xong mới ghép), chống màn hình đen!
// ==========================================
...
window.captureFrames = function() {
    ...
    if (renderNormalV) {
        ...
        if (!isOutroActive) {
            ...
            // Đã tắt rung lắc (audioPeak) để lát hậu kỳ đắp video lên khớp hoàn toàn 100%
...
window.mergeAndDownloadVideo = async function(vidId) {
    ...
    function drawLoop() {
        ...
        if (!rawVid.paused) {
            ...
            // Tự động Crop Facecam & Vẽ đè lên nền đen
