// ==========================================
// ENGINE.JS - THE ABSOLUTE ULTIMATE MASTERPIECE 38.1 [WHITEBEARD EDITION]
        ...
        if (target.hp <= 0) {
            ...
            if (isNearWall && isCrit && typeof window.triggerStageTransition === 'function') { window.triggerStageTransition(target); } 
                ...
                if (isCrit) {
                    ...
                    window.targetZoom = 1.8; window.actionCamOffsetX = (target.isFacingRight ? 120 : -120); window.actionCamOffsetY = -50; window.dynamicBlur = 25; window.cameraTilt = (Math.random() > 0.5 ? 1 : -1) * 0.15; 
