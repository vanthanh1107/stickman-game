...
window.StoryModeAI = {
    ...
    generateViralStickmanTitle: function(hero, enemy) {
        // 1. TỪ VỰNG TÂM LÝ CHIẾN & KỸ NĂNG DỊ (Lạ, Hấp dẫn, Gây tò mò cực mạnh)
        ...
        // 2. CÔNG THỨC VIRAL (Nhấn mạnh sự tàn nhẫn, phi thực tế và thao túng)
        const templates = [
        ...
        // 4. HASHTAG NGÁCH CHUẨN TIKTOK (Tập trung vào sự điên rồ, não to, và movement)
        const allTags = [
