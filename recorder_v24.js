// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V55.0 - MEME EMBED & AUTO-CUT)
// [FIXED] Tự động dừng quay khi hết trận & Bật bảng điều khiển ra giữa màn hình.
...
window.bakeThumbnailsForVideo = function(titleText) {
    ...
    let bgStyle = Math.random() > 0.5 ? 'sunburst' : 'checkerboard'; // Random kiểu nền Meme
    ...
    // --- VẼ BẢN NGANG ---
    window.ctx = ctxH; ctxH.filter = 'contrast(1.5) saturate(1.8)'; // Deep Fried Filter
...
window.captureFrames = function() {
    ...
    // 🔥 [AUTO CUT] TỰ ĐỘNG TẮT RECORD KHI TRẬN ĐẤU KẾT THÚC ~3 GIÂY
    if (window.gameOver && window.matchEndTimer > 200) {
