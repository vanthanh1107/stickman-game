// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V66.11 - RAW 60FPS ENGINE)
// [FIX TỐI THƯỢNG] Ép Bitrate lên 50 Mbps (Xả thẳng dữ liệu thô, không nén). File nặng nhưng MƯỢT 100%.
// [FIX TỐI THƯỢNG] Ép sử dụng H.264 Hardware Encoding (Dùng GPU thay vì CPU) để chống Drop Frame.
// [LƯU Ý] Video tải về hãy ném thẳng vào CapCut hoặc TikTok để xem độ mượt thực sự (Trình phát của Windows hay bị lỗi metadata).
// [RETAINED] Mọi hiệu ứng TikTok Meta (Split-Screen, Lưới 3D, RGB Glitch, Pop-in Emojis).
// ==========================================
...
window.startRecording = function() {
    ...
    // [FIX TỐI THƯỢNG] NÂNG LÊN 50MBPS (Xả RAW không nén) & Ép dùng H.264 (Phần cứng)
    let options = { videoBitsPerSecond: 50000000 }; 
    window.currentVideoExt = "mp4";
    let mimeType = "";

    // Tìm kiếm Codec được hỗ trợ Hardware tốt nhất
