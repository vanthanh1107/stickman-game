...
window.MAPS = [
    ...
    { id: "underwater_atlantis", sky: "#001f3f", bg1: "#003366", bg2: "#00509e", ground: "#001122", line: "#00ffff", weather: "snow", bg1Type: "crystals", bg2Type: "river" },
    ...
    // ==========================================
    { id: "mainframe_core", sky: "#001100", bg1: "#004400", bg2: "#002200", ground: "#000500", line: "#00ff00", weather: "rain", bg1Type: "digital", bg2Type: "pillars" }, // Lõi máy chủ ma trận
    { id: "synthwave_drive", sky: "#2a0845", bg1: "#8e44ad", bg2: "#e67e22", ground: "#110011", line: "#ff00ff", weather: "none", bg1Type: "digital", bg2Type: "mountains" }, // Phong cách Retrowave thập niên 80
    { id: "glitch_dimension", sky: "#000000", bg1: "#ff00ff", bg2: "#00ffff", ground: "#111111", line: "#ffffff", weather: "toxic", bg1Type: "digital", bg2Type: "stars" }, // Đứt gãy không gian màu RGB
    { id: "steampunk_slums", sky: "#4a2311", bg1: "#873600", bg2: "#5c4033", ground: "#2e150b", line: "#d35400", weather: "ash", bg1Type: "city", bg2Type: "ruins" }, // Thế giới máy móc hơi nước
    { id: "cyber_yakuza", sky: "#0a0a0a", bg1: "#800000", bg2: "#330000", ground: "#050505", line: "#ff003c", weather: "rain", bg1Type: "pillars", bg2Type: "city" }, // Võ đường Yakuza trong mưa Neon

    // ==========================================
    // 7. CÕI ÂM & KHÔNG GIAN BẤT ĐỊNH (PURGATORY & LIMBO)
    // ==========================================
    { id: "the_backrooms", sky: "#f4f4d7", bg1: "#e3e3b5", bg2: "#d1d193", ground: "#baba7a", line: "#8c8c54", weather: "none", bg1Type: "pillars", bg2Type: "none" }, // Không gian mê cung vàng ố đáng sợ
    { id: "eldritch_abyss", sky: "#1a0033", bg1: "#330066", bg2: "#00331a", ground: "#0a001a", line: "#00ff66", weather: "toxic", bg1Type: "graves", bg2Type: "trees" }, // Xúc tu vĩ đại, tà thần Lovecraft
    { id: "blood_ocean", sky: "#330000", bg1: "#660000", bg2: "#990000", ground: "#1a0000", line: "#ff3333", weather: "ash", bg1Type: "graves", bg2Type: "river" }, // Biển máu và nghĩa địa
    { id: "infernal_throne", sky: "#000000", bg1: "#cc3300", bg2: "#ff6600", ground: "#110000", line: "#ff9900", weather: "ash", bg1Type: "crystals", bg2Type: "mountains" }, // Ngai vàng dung nham Quỷ Vương
    { id: "frozen_hell", sky: "#001122", bg1: "#003366", bg2: "#005599", ground: "#000a14", line: "#00ffff", weather: "snow", bg1Type: "crystals", bg2Type: "mountains" }, // Địa ngục băng giá đen kịt
    { id: "limbo_void", sky: "#555555", bg1: "#777777", bg2: "#333333", ground: "#222222", line: "#ffffff", weather: "ash", bg1Type: "graves", bg2Type: "clouds" }, // Cõi hư vô xám xịt không màu sắc

    // ==========================================
    // 8. ĐỈNH CAO THẦN THÁNH & THIÊN CỔ (DIVINE REALMS)
    // ==========================================
    { id: "valhalla_hall", sky: "#f9e79f", bg1: "#f1c40f", bg2: "#f39c12", ground: "#d4ac0d", line: "#ffffff", weather: "snow", bg1Type: "pillars", bg2Type: "clouds" }, // Cung điện vàng Valhalla của Odin
    { id: "olympus_peak", sky: "#aed6f1", bg1: "#d6eaf8", bg2: "#85c1e9", ground: "#ebf5fb", line: "#3498db", weather: "petals", bg1Type: "pillars", bg2Type: "mountains" }, // Đỉnh Olympus cẩm thạch
    { id: "yggdrasil_roots", sky: "#0b5345", bg1: "#1d8348", bg2: "#f1c40f", ground: "#073b26", line: "#27ae60", weather: "petals", bg1Type: "trees", bg2Type: "stars" }, // Rễ cây Thần Yggdrasil phát sáng
    { id: "shambhala", sky: "#117864", bg1: "#1abc9c", bg2: "#48c9b0", ground: "#0b5345", line: "#a2d9ce", weather: "petals", bg1Type: "trees", bg2Type: "mountains" }, // Vùng đất ngọc bích ẩn giấu
    { id: "astral_forge", sky: "#154360", bg1: "#8e44ad", bg2: "#2980b9", ground: "#0e2c40", line: "#9b59b6", weather: "snow", bg1Type: "crystals", bg2Type: "stars" }, // Lò rèn vũ khí giữa dải ngân hà

    // ==========================================
    // 9. NHỮNG GIẤC MƠ BẤT BÌNH THƯỜNG (BIZARRE DREAMS)
    // ==========================================
    { id: "candy_land", sky: "#ffb6c1", bg1: "#ff69b4", bg2: "#00ffff", ground: "#ff1493", line: "#ffffff", weather: "snow", bg1Type: "trees", bg2Type: "mountains" }, // Thế giới kẹo ngọt (Tuyết làm đường)
    { id: "neon_jungle", sky: "#000000", bg1: "#39ff14", bg2: "#ff00ff", ground: "#050505", line: "#00ffff", weather: "toxic", bg1Type: "trees", bg2Type: "river" }, // Khu rừng phát sáng huỳnh quang
    { id: "paper_manga", sky: "#ffffff", bg1: "#dddddd", bg2: "#cccccc", ground: "#eeeeee", line: "#000000", weather: "none", bg1Type: "ruins", bg2Type: "city" }, // Thế giới truyện tranh Manga nét mực đen
    { id: "shattered_glass", sky: "#e5e8e8", bg1: "#85c1e9", bg2: "#d6eaf8", ground: "#b2babb", line: "#000000", weather: "snow", bg1Type: "crystals", bg2Type: "mountains" }, // Không gian gương vỡ
    { id: "quantum_realm", sky: "#1a0033", bg1: "#ff00ff", bg2: "#00ffff", ground: "#0a001a", line: "#ffffff", weather: "rain", bg1Type: "digital", bg2Type: "stars" }, // Thế giới lượng tử siêu vi
    { id: "time_chamber", sky: "#fcf3cf", bg1: "#f1c40f", bg2: "#b9770e", ground: "#f8c471", line: "#ffffff", weather: "ash", bg1Type: "digital", bg2Type: "pillars" }, // Căn phòng Thời Gian vô tận
    { id: "abyssal_trench", sky: "#000511", bg1: "#001133", bg2: "#002244", ground: "#00020a", line: "#0088ff", weather: "snow", bg1Type: "ruins", bg2Type: "river" }, // Rãnh đáy biển Mariana (Tuyết giả làm bọt khí)
    { id: "solar_core", sky: "#ffdd00", bg1: "#ff8800", bg2: "#ff4400", ground: "#aa3300", line: "#ffffff", weather: "ash", bg1Type: "mountains", bg2Type: "none" } // Đánh nhau ngay trong Lõi Mặt Trời
];
