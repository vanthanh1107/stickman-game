// ==========================================
// CHAR_BILLGATES.JS - NHÂN VẬT BILL GATES (KÈM AVATAR HÌNH ẢNH 3D KHÔNG VIỀN)
// ==========================================
...
window.currentLoadedChar = {
    ...
    drawMethod: function(ctx, p, bounce, ext, pext, isTrail) {
        ...
        // ==========================================
        // 3. VẼ ĐẦU NHÂN VẬT BẰNG AVATAR HÌNH ẢNH (KHÔNG VIỀN MÀU + CÓ KHỐI 3D)
        // ==========================================
        ...
        if (currentAvatar) {
            // Tải và lưu cache ảnh để không bị giật lag
            ...
            if (img && img.complete && img.naturalWidth > 0) {
                ...
                // Áp dụng Filter để màu sắc ảnh tệp với màu Game
                ...
                // Phủ lớp bóng 3D lên mặt (Đổ bóng khối cầu)
                let faceShadow = ctx.createRadialGradient(
                    headSize * 0.15, -headSize * 0.15, 0, 
                    0, 0, headSize / 2
                );
                faceShadow.addColorStop(0, "rgba(255, 255, 255, 0.15)"); 
                ...
                ctx.strokeStyle = "rgba(255, 255, 255, 0.9)"; // Kính màu trắng cho nổi bật trên ảnh
                ctx.lineWidth = 1.5;
