// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V61.0 - EDITOR'S CHOICE FIX)
// [FIXED] Sửa lỗi Video bị cắt ngắn còn vài giây, không thể edit trên Premiere/CapCut (Bỏ start(1000) gây hỏng Timestamp).
// [NEW] CFR HACK: Ép trình duyệt xuất video chuẩn 60FPS nguyên khối (Constant Frame Rate), không bị mất frame.
...
window.startRecording = function() {
    ...
    // BỎ start(1000) ĐỂ KHÔNG BỊ TRÌNH DUYỆT CHIA CHUNK LÀM HỎNG FILE TIMESTAMPS
...
window.captureFrames = function() {
    ...
    if (window.gameOver && window.matchEndTimer > 350) {
        window.stopRecording(); return;
    }
    
    let ctxH = window.recordCtxH; let ctxV = window.recordCtxV; 

    // [CFR HACK] - CHỐNG LỖI CẮT NGẮN TRÊN TRÌNH EDIT VIDEO
    ...
    ctxV.fillStyle = "#0a0a14"; ctxV.fillRect(0, 0, 1080, 1920); ctxV.imageSmoothingEnabled = false;
