// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V66.14 - 120HZ WEBM OVERDRIVE)
// [ULTIMATE FPS] Ép xung thu hình lên 120 FPS cực mượt, không bỏ lỡ một chuyển động nào.
// [GPU BYPASS] Bật 'desynchronized: true' để vẽ trực tiếp qua Card màn hình, triệt tiêu giật khựng.
// [SWEET SPOT] Bitrate 20 Mbps + Định dạng WebM VP9: Đỉnh cao sắc nét và ổn định.
// [RETAINED] 1080p Downscale (Nhẹ máy), Profile Fake Grid, RGB Glitch, TikTok AI Captions.
// ==========================================
...
window.currentVideoExt = "webm"; // CHUẨN WEBM CHO ĐỘ MƯỢT TỐI ĐA TRÊN PC
window.savedVideos = [];
window.filmDustY = 0; 
...
window.initRecorder = function() {
    ...
    // [FIX 120HZ GPU BYPASS] Bật desynchronized để nối thẳng Canvas vào Card Màn Hình
...
window.startRecording = function() {
    ...
    // [FIX 120Hz OVERDRIVE] Ép trình duyệt thu nhận 120 Khung hình mỗi giây
    let videoStreamH = window.recordCanvasH.captureStream(120); 
    let videoStreamV = window.recordCanvasV.captureStream(120); 
    ...
    // [FIX BITRATE 20Mbps] Cân bằng hoàn hảo cho WebM VP9 ở 120 FPS
    ...
    // Ghi nguyên 1 khối duy nhất, không ngắt quãng
...
window.captureFrames = function() {
    ...
    try {
        // [CFR HACK] Vẽ thay đổi nhỏ nhất mỗi frame để ép MediaRecorder ghi lại đủ 120 FPS
