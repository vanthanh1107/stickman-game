// ==========================================
// RECORDER.JS - V76.5 ULTIMATE AUTO-UPLOAD EDITION
// ĐÃ TÍCH HỢP: Make.com Webhook Silent Upload
// NÂNG CẤP V76.4: ANIME SLASH PERFECT LOOP & KINETIC SUBTITLES
// ==========================================
...
window.sendVideoToWebhook = async function(videoBlob, title, description) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            window.showRenderToast("❌ LỖI TẢI LÊN MÁY CHỦ!");
            return false;
        }
    } catch (e) {
        console.error("Lỗi Webhook:", e);
        window.showRenderToast("❌ LỖI MẠNG KHI GỬI VIDEO!");
        return false;
    }
};
