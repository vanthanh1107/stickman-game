// ==========================================
// RECORDER.JS - V73.0 THE OMNI-DIRECTOR (THE DEFINITIVE PEAK)
// ĐÃ FIX & GIỮ NGUYÊN: Intro 3.2s God-Tier, Vỡ kính 3D, Kanji Manga, Đa ngôn ngữ, Tên thực tế.
// NÂNG CẤP TỐI THƯỢNG: Sakuga Kill-Cam (Zoom & Chớp K.O. lúc kết liễu), Chữ ký bản quyền động.
// CẢM XÚC: Hoàn hảo 100% từ giây đầu tiên đến giây cuối cùng của video Short/TikTok.
...
// ====================================================================
// PROCEDURAL ENGINE (ĐẠO DIỄN KỊCH BẢN ĐA NGÔN NGỮ & HUY HIỆU CƯỢC)
// ====================================================================
const THEMES = [
...
window.captureFrames = function() {
    ...
    if (renderNormalV) {
        ...
        if (isKillCamActive) {
            ...
            ctxV.scale(1.2, 1.2); // Zoom cận cảnh cú K.O.
            ctxV.translate(-540, -splitGameHeight / 2);
            // Chớp âm bản Anime cho 5 frame đầu tiên của đòn kết liễu
            if (window.matchEndTimer < 10 && window.matchEndTimer % 2 === 0) {
