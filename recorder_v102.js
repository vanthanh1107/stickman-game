...
// ĐÃ NÂNG CẤP: AI SINH TIÊU ĐỀ & HASHTAG + AI SINH TOXIC COMMENTS KHÔNG GIỚI HẠN
// ==========================================
...
// ====================================================================
// 🎯 KHU VỰC TÙY CHỈNH: VIDEO MÈO NỀN XANH & CELEB
// ====================================================================
...
// ====================================================================
// ENGINE AI NỘI BỘ TẠO TOXIC COMMENTS
// ====================================================================
window.generateToxicComment = function() {
    const subjects = ["Bro", "Blud", "Lil bro", "This guy", "Dude", "My man", "He", "Bro really", "Dawg"];
    const actions = [
    ...
    const comparisons = [
        ...
        "Worst gameplay I have ever seen", "My blind cousin plays better"
    ];
    const insults = [
        "Skill issue", "Absolute garbage", "0 IQ gameplay", "Literal trash", 
        "Brain dead combo", "Delete the game", "Uninstall pls", "So bad it hurts", "Cringe"
    ];
    const gear = ["combo", "keyboard", "monitor", "gaming chair", "wifi", "mouse"];
    const emojis = ["💀", "😭", "🗑️", "🤡", "📉", "🥶", "📸", "🗿", "🤢", "💩", "🤬", "👎", "🤣"];
    ...
    const templates = [
        ...
        () => `Someone take his PC away immediately ${r(emojis)}`,
    ...
    if (!isOutroActive) {
        ...
        if (!window._chatSystemInit) {
            ...
            for(let i = 0; i < 8; i++) {
                ...
                let randomMsg = window.generateToxicComment(); // <--- Đã thay bằng Hàm AI
