// ==========================================
// FILE: characters/satthu.js (Nhân vật mẫu)
// ==========================================
...
const CharacterModule = {
    ...
    // 1. LOGIC ĐÒN ĐÁNH & TUYỆT CHIÊU RIÊNG
    skill: {
        actionCode2: function(caster, target, ctx) {
            ...
            caster.state = 'spinning_backfist'; 
    ...
    // 2. PHƯƠNG THỨC VẼ TRANG BỊ VÀ ĐỒ HỌA RIÊNG
    drawMethod: function(ctx, p, bounce, ext, pext, isTrail) {
        // Gọi hàm khung xương toàn cục vừa giải phóng ở Bước 1
        ...
        // Gắn vũ khí: Dao găm Sát thủ phát sáng xanh độc quyền
        ctx.strokeStyle = "#2ed573"; ctx.lineWidth = 3; 
        ctx.shadowBlur = isTrail ? 0 : 8; ctx.shadowColor = "#2ed573"; 
...
// Đưa module này lên window để hệ thống nạp dữ liệu nhận diện được
