// ==========================================
// RECORDER.JS - V77.1 THE ULTIMATE ALGORITHM BREAKER (YOUTUBE SHORTS EDITION)
// ĐÃ FIX & GIỮ NGUYÊN: Intro God-Tier, Vỡ kính 3D, Kill-Cam, Facecam Hậu Kỳ Không Giật Lag.
// TÍCH HỢP MỚI: Tự động Upload lên YouTube Shorts qua Google Apps Script (Bypass CORS, Base64 Cleaned).
// ==========================================
...
window.sendVideoToWebhook = async function(videoBlob, title, description) {
    window.showRenderToast("☁️ ĐANG MÃ HÓA & GỬI LÊN YOUTUBE SHORTS...");
    ...
    return new Promise((resolve, reject) => {
        ...
        reader.onloadend = async function() {
            // FIX LỖI "KHÔNG THỂ GIẢI MÃ CHUỖI": Tách chuẩn Base64, loại bỏ hoàn toàn header
