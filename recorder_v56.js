// ==========================================
// RECORDER.JS - BẢN HOÀN HẢO CHO CONTENT CREATOR (V66.2 - SMOOTH SPLIT-SCREEN TIKTOK)
// [NEW] Bố cục Split-Screen: Game 16:9 ở trên, Retention Zone Cyberpunk ở dưới.
// [FIX] Tối ưu hóa GPU Batch Drawing lưới Cyberpunk (Giảm lag triệt để 100%).
// [FIX] Pixel-perfect rendering: Dùng Math.floor chống nhòe và rớt frame.
// [FIX] Giảm Bitrate xuống 15 Mbps (Mức vàng cho 2K) để Encoder không bị nghẽn.
// ==========================================
...
window.startRecording = function() {
    ...
    // [FIX] Giảm Bitrate xuống 15 Mbps cho Encoder mượt mà
...
window.captureFrames = function() {
    ...
    // [CFR HACK] CHỐNG LỖI CẮT NGẮN CỦA PREMIERE/CAPCUT 
    ...
    // 3. BACKGROUND CHO RETENTION ZONE 
    // [FIX] TỐI ƯU CỰC MẠNH Ở ĐÂY: KHÔNG DÙNG CLIP(), DÙNG BATCH DRAWING LƯỚI
    ...
    // [FIX] Gộp nét vẽ Grid để chống tràn VRAM GPU gây rớt Frame
    ...
    if (window.p1 && !window.gameOver && window.introTimer <= 120) {
        ...
        // --- HUD DỌC 2K ---
        let hudBaseY = splitGameHeight + 120; 
    ...
    if (!window.gameOver) {
        ...
        let subY = (typeof splitGameHeight !== 'undefined') ? splitGameHeight + 550 : 1400; 
