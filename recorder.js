...
window.startRecording = function() {
    ...
    // DẪN ÂM THANH TỪ NHẠC NỀN (BGM) VÀO VIDEO
...
window.captureFrames = function() {
    ...
    if (window.p1 && !window.gameOver && window.introTimer <= 120) {
        ...
        if (img1) {
            ctxV.save();
            ctxV.beginPath(); if (ctxV.roundRect) ctxV.roundRect(50, 85, 65, 65, 8); else ctxV.rect(50, 85, 65, 65); ctxV.clip();
            ctxV.drawImage(img1, 50, 85, 65, 65); ctxV.restore();
            ctxV.lineWidth = 5; ctxV.strokeStyle = "#00f3ff"; ctxV.strokeRect(50, 85, 65, 65);
        }
        ctxV.lineWidth = 8; ctxV.strokeStyle = "#000"; ctxV.strokeText(p1Name, 135, 140); ctxV.fillStyle = "#fff"; ctxV.fillText(p1Name, 135, 140);
        ...
        if (window.enemies && window.enemies.length > 0) {
            ...
            ctxV.lineWidth = 8; ctxV.strokeStyle = "#000"; ctxV.strokeText(eName, 945, 1640); ctxV.fillStyle = "#fff"; ctxV.fillText(eName, 945, 1640);
