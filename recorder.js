// ==========================================
// RECORDER.JS - ĐỒNG BỘ KHUẾCH ĐẠI CHẤT LƯỢNG ÂM THANH VIDEO XUẤT RA
// ==========================================
...
window.startRecording = function() {
    ...
    if (!window.audioHookInstalled) {
        ...
        AudioNode.prototype.connect = function(destination, output, input) {
            if (destination === window.audioCtx.destination && window.recordAudioDestination) { try { originalConnect.call(this, window.recordAudioDestination, output, input); } catch(e){} }
...
window.stopRecording = function() { if (!window.isRecording || !window.mediaRecorder) return; try { window.mediaRecorder.requestData(); } catch(e){} window.mediaRecorder.stop(); window.isRecording = false; };
